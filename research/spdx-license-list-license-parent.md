# SPDX License List - License - Parent
...
| BSD 2-Clause - position unchanged variant | BSD-2-Clause-pos-unchanged | BSD-2-Clause | |
| BSD 2-Clause with views sentence | BSD-2-Clause-Views | BSD-2-Clause | |
...
| BSD 3-Clause - OpenWebUI variant | BSD-3-Clause-OpenWebUI | (BSD-3-Clause) | |
| BSD 3-Clause Sun Microsystems | BSD-3-Clause-Sun | (BSD-3-Clause-No-Nuclear-Warranty) | |
| BSD 3-Clause Tso variant | BSD-3-Clause-Tso | (BSD-3-Clause) | |
...
| BSD Mark Modifications License | BSD-Mark-Modifications | (BSD-3-Clause) | |
| BSD Protection License | BSD-Protection | | |
| BSD Source Code Attribution - GPL alternative | BSD-Source-alt-GPL | (BSD-Source-Code) | |
...
| BSD Source Code Attribution - no disclaimer | BSD-Source-Code-no-disclaimer | (BSD-Source-Code) | |
| Systemics BSD variant license | BSD-Systemics | | |
| Systemics W3Works BSD variant license | BSD-Systemics-W3Works | | |
| Boost Software License 1.0 | BSL-1.0 | | |
| Buddy License | Buddy | MIT-Modern-Variant | |
...
| check-cvs License | check-cvs | (FSFULLR) | |
...
| HPND - sell variant with safety critical systems clause | HPND-sell-variant-critical-systems | (HPND-sell-variant) | |
...
| Historical Permission Notice and Disclaimer - SMC variant | HPND-SMC | (HPND) | |
...
| Lesser General Public License For Linguistic Resources | LGPLLR | LGPL-2.1 | |
...
| Mup License | Mup | | |
| MVT License 1.1 | MVT-1.1 | MPL-2.0 | |
...
| Do What The F*ck You Want To But It's Not My Fault Public License | WTFNMFPL | (WTFPL) | |
| Do What The F*ck You Want To Public License | WTFPL | | |
| WWL License | wwl | | |
| X11 License | X11 | (MIT) | |
| X11 License Distribution Modification Variant | X11-distribute-modifications-variant | (X11) | |
| X11 no permit persons clause | X11-no-permit-persons | (X11) | |
