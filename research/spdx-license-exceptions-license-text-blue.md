...
| [kvirc OpenSSL Exception](https://spdx.org/licenses/kvirc-openssl-exception.html) | kvirc-openssl-exception | 3.28.0 | none | blue (since [3.28.0](https://github.com/spdx/license-list-data/blob/v3.28.0/html/kvirc-openssl-exception.html)) | N/A |
