# SPDX License Exceptions - License - Text - Blue (Omittable Text)
...
| [Classpath exception 2.0](https://spdx.org/licenses/Classpath-exception-2.0.html) | Classpath-exception-2.0 | 2.1 | blue (since [3.21](https://github.com/spdx/license-list-data/blob/v3.21/html/Classpath-exception-2.0.html)), black (until [3.20](https://github.com/spdx/license-list-data/blob/v3.20/html/Classpath-exception-2.0.html)) | N/A | N/A |
...
| [GCC Runtime Library exception 2.0](https://spdx.org/licenses/GCC-exception-2.0.html) | GCC-exception-2.0 | 2.1 | blue (since [3.1](https://github.com/spdx/license-list-data/blob/v3.1/html/GCC-exception-2.0.html)), black (until [3.0](https://github.com/spdx/license-list-data/blob/v3.0/html/GCC-exception-2.0.html)) | N/A | N/A |
...
| [OpenJDK Assembly exception 1.0](https://spdx.org/licenses/OpenJDK-assembly-exception-1.0.html) | OpenJDK-assembly-exception-1.0 | 3.1 | blue (since [3.3](https://github.com/spdx/license-list-data/blob/v3.3/html/OpenJDK-assembly-exception-1.0.html)), black (until [3.2](https://github.com/spdx/license-list-data/blob/v3.2/html/OpenJDK-assembly-exception-1.0.html)) | blue (since [3.1](https://github.com/spdx/license-list-data/blob/v3.1/html/OpenJDK-assembly-exception-1.0.html)) | N/A |
| [OpenVPN OpenSSL Exception](https://spdx.org/licenses/openvpn-openssl-exception.html) | openvpn-openssl-exception | 2.2 | none | blue (since [3.1](https://github.com/spdx/license-list-data/blob/v3.1/html/openvpn-openssl-exception.html)), black (until [3.0](https://github.com/spdx/license-list-data/blob/v3.0/html/openvpn-openssl-exception.html)) | N/A |
