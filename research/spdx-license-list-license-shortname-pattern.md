# SPDX License List - License - Short Name - Pattern
...
| Advanced Cryptics Dictionary License | Advanced-Cryptics-Dictionary | Advanced-Cryptics-Dictionary | | |
...
| ALGLIB Documentation License | ALGLIB-Documentation | ALGLIB-Documentation | | |
...
| App::s2p License | App-s2p | App-s2p | | |
...
| Artistic License 1.0 (dist) | Artistic-dist | Artistic | dist | |
| Aspell Russian License | Aspell-RU | Aspell-RU | | |
...
| atc Game License | atc-game | atc-game | | |
...
| Boehm-Demers-Weiser GC License (without fee) | Boehm-GC-without-fee | Boehm-GC | | without-fee |
| Buena Onda License Agreement v1.1 | BOLA-1.1 | BOLA | 1.1 | |
| Borceux license | Borceux | Borceux | | |
| Brian Gladman 2-Clause License | Brian-Gladman-2-Clause | Brian-Gladman | 2-Clause | |
| Brian Gladman 3-Clause License | Brian-Gladman-3-Clause | Brian-Gladman | 3-Clause | `(?!\W*no\W*conversion)` |
| Brian Gladman 3-Clause License (no conversion clause) | Brian-Gladman-3-Clause-no-conversion | Brian-Gladman | 3-Clause | no-conversion |
| BSD 1-Clause License | BSD-1-Clause | BSD | 1-Clause | |
| BSD 2-Clause "Simplified" License | BSD-2-Clause | BSD | 2-Clause | `(?!\W*Darwin\|\W*Patent\|\W*pos\W*unchanged\|\W*Views)` |
...
| BSD 2-Clause - position unchanged variant | BSD-2-Clause-pos-unchanged | BSD | 2-Clause | pos-unchanged |
...
| BSD 3-Clause Flex variant | BSD-3-Clause-flex | BSD | 3-Clause | flex |
...
| BSD 3-Clause - OpenWebUI variant | BSD-3-Clause-OpenWebUI | BSD | 3-Clause | OpenWebUI |
...
| BSD - ask to endorse | BSD-ask-to-endorse | BSD | | ask-to-endorse |
...
| BSD Mark Modifications License | BSD-Mark-Modifications | BSD | | Mark-Modifications |
| BSD Protection License | BSD-Protection | BSD | | Protection |
| BSD Source Code Attribution - GPL alternative | BSD-Source-alt-GPL | BSD | | Source-alt-GPL |
| BSD Source Code Attribution - beginning of file variant | BSD-Source-beginning-file | BSD | | Source-beginning-file |
| BSD Source Code Attribution | BSD-Source-Code | BSD | | Source-Code `(?!\W*no\W*disclaimer)` |
| BSD Source Code Attribution - no disclaimer | BSD-Source-Code-no-disclaimer | BSD | | Source-Code-no-disclaimer |
...
| Buddy License | Buddy | Buddy | | |
| Bugroff License | Bugroff | Bugroff | | |
...
| Common Attack Pattern Enumeration and Classification License | CAPEC-tou | CAPEC-tou | | |
...
| Creative Commons Attribution Non Commercial 3.0 Unported | CC-BY-NC-3.0 | CC-BY-NC | 3.0 | `(?!\W*DE\|\W*IGO)` |
| Creative Commons Attribution Non Commercial 3.0 Germany | CC-BY-NC-3.0-DE | CC-BY-NC | 3.0 | DE |
| Creative Commons Attribution Non Commercial 3.0 IGO | CC-BY-NC-3.0-IGO | CC-BY-NC | 3.0 | IGO |
...
| Creative Commons Attribution Share Alike 1.0 Generic | CC-BY-SA-1.0 | CC-BY-SA | 1.0 | |
...
| Creative Commons Public Domain Mark 1.0 Universal | CC-PDM-1.0 | CC-PDM | 1.0 | |
| Creative Commons Share Alike 1.0 Generic | CC-SA-1.0 | CC-SA | 1.0 | |
...
| CNRI Python License | CNRI-Python | CNRI-Python | | `(?!\W*GPL\W*Compatible)` |
...
| CryptoSwift License | CryptoSwift | CryptoSwift | | |
...
| DocBook DTD License | DocBook-DTD | DocBook-DTD | | |
| DocBook Schema License | DocBook-Schema | DocBook-Schema | | |
| DocBook Stylesheet License | DocBook-Stylesheet | DocBook-Stylesheet | | |
...
| Elastic License 2.0 | Elastic-2.0 | Elastic | 2.0 | |
...
| European Space Agency Public License – v2.4 – Permissive (Type 3) | ESA-PL-permissive-2.4 | ESA-PL | 2.4 | permissive |
| European Space Agency Public License (ESA-PL) - V2.4 - Strong Copyleft (Type 1) | ESA-PL-strong-copyleft-2.4 | ESA-PL | 2.4 | strong-copyleft |
| European Space Agency Public License – v2.4 – Weak Copyleft (Type 2) | ESA-PL-weak-copyleft-2.4 | ESA-PL | 2.4 | weak-copyleft |
...
| Fraunhofer FDK MPEG-H Software | FDK-MPEG-H | FDK-MPEG-H | | |
...
| Game Programming Gems License | Game-Programming-Gems | Game-Programming-Gems | | |
| Gnome GCR Documentation License | GCR-docs | GCR-docs | | |
| GD License | GD | GD | | |
| Generic XTS License | generic-xts | generic-xts | | |
...
| Historical Permission Notice and Disclaimer - SMC variant | HPND-SMC | HPND-SMC | | |
...
| hyphen-bulgarian License | hyphen-bulgarian | hyphen-bulgarian | | |
...
| Informatica License | Informatica | Informatica | | |
| Inner Net License v2.0 | Inner-Net-2.0 | Inner-Net | 2.0 | |
| Inno Setup License | InnoSetup | InnoSetup | | |
...
| ISO permission notice | ISO-permission | ISO-permission | | |
| Jam License | Jam | Jam | | |
| JasPer License | JasPer-2.0 | JasPer | 2.0 | |
| Jove License | jove | jove | | |
...
| man2html License | man2html | man2html | | |
...
| MIT-STK License | MIT-STK | MIT-STK | | |
...
| Minecraft Mod Public License v1.0.1 | MMPL-1.0.1 | MMPL | 1.0.1 | |
...
| Mup License | Mup | Mup | | |
| MVT License 1.1 | MVT-1.1 | MVT | 1.1 | |
...
| NRL License | NRL | NRL | | |
| NTIA Public Domain Notice | NTIA-PD | NTIA-PD | | |
...
| Open LDAP Public License v2.7 | OLDAP-2.7 | OLDAP | 2.7 | |
...
| OpenMDW License Agreement v1.0 | OpenMDW-1.0 | OpenMDW | 1.0 | |
...
| OSC License 1.0 | OSC-1.0 | OSC | 1.0 | |
...
| OSSP License | OSSP | OSSP | | |
| PADL License | PADL | PADL | | |
| ParaType Free Font Licensing Agreement v1.3 | ParaType-Free-Font-1.3 | ParaType-Free-Font | 1.3 |
...
| Sendmail Open Source License v1.1 | Sendmail-Open-Source-1.1 | Sendmail-Open-Source | 1.1 | |
...
| SGMLUG Parser Materials License | SGMLUG-PM | SGMLUG-PM | | |
...
| SOFA Software License | SOFA | SOFA | | |
...
| Sustainable Use License v1.0 | SUL-1.0 | SUL | 1.0 | |
...
| TrustedQSL License | TrustedQSL | TrustedQSL | | |
...
| Unicode License v3 | Unicode-3.0 | Unicode | 3.0 | |
...
| Unlicense - libtelnet variant | Unlicense-libtelnet | Unlicense | | libtelnet |
| Unlicense - libwhirlpool variant | Unlicense-libwhirlpool | Unlicense | | libwhirlpool |
| UnRAR License | UnRAR | UnRAR | | |
...
| WordNet License | WordNet | WordNet | | |
...
| Zend License v2.0 | Zend-2.0 | Zend | 2.0 | |
